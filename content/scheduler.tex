...
b\begin{figure}[!b]
		...
		\end{figure}
			...
			\begin{figure}[!ht]
			\centering{
				\input{figures/electionfunction_schedule.tex}
...
\textcolor{red}{Passer le reste du paragraphe de comparaison avec l'état de l'art dans le chapitre de l'état de l'art ?}\\
