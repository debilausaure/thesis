...
Fixpoint writeContextAux (contextSaveAddr : vaddr) (currIdx : index)
  ...
  | S dec_bound =>
	...
	Pointeurs sur la base de code.
	% Remarques pragmatiques sur cette contribution
		\subsection{Métriques}
		Nombre de ligne de code Coq, nombre de ligne de code C générées, Nombre de ligne de preuve relativement faible comparé aux 85000 lignes de Narjes, temps passé sur la preuve
		==> réutilisation de la preuve mais aussi de la méthodologie
