\begin{tikzpicture}[>=triangle 45,font=\sffamily, every text node part/.style={align=center}, scale=1, every node/.style={transform shape}] {
	...
	\node[draw, fill=white, ultra thin, drop shadow, minimum height=1.5cm, align=center] (parents_checks) at (0.5,2.75) {Récupération VIDT appelant\\(partition interrompue)};
